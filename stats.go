...
var StatNames = map[int]string{
	...
	STAT_STATPOINTSLEFT:  "stat points",
	STAT_NEWSKILLS:       "new skills",
	STAT_HP:              "life",
	STAT_MAXHP:           "max life",
	STAT_MANA:            "mana",
	...
	STAT_EXP:             "experience",
	STAT_GOLD:            "gold",
	STAT_GOLDBANK:        "stash gold",
	STAT_ENHANCEDDEFENSE: "%% enhanced defense",
	//STAT_ENHANCEDMAXIMUMDAMAGE: "%% enhanced max damage",
	//STAT_ENHANCEDMINIMUMDAMAGE: "%% enhanced min damage",
	STAT_ATTACKRATING:  "attack rating",
	STAT_TOBLOCK:       "%% to block",
	STAT_MINIMUMDAMAGE: "min damage",
	STAT_MAXIMUMDAMAGE: "max damage",
	//STAT_SECONDARYMINIMUMDAMAGE: "secondary min damage",
	//STAT_SECONDARYMAXIMUMDAMAGE: "secondary max damage",
	STAT_ENHANCEDDAMAGE: "%% enhanced damage",
	//STAT_MANARECOVERY = 26
	//STAT_MANARECOVERYBONUS = 27
	//STAT_STAMINARECOVERYBONUS = 28
	//STAT_LASTEXPERIENCE = 29
	//STAT_NEXTEXPERIENCE = 30
	STAT_DEFENSE: "defense",
	//STAT_DEFENSEVSMISSILES = 32
	//STAT_DEFENSEVSMELEE = 33
}
